...
(0,_utils_custom_element__WEBPACK_IMPORTED_MODULE_1__.createCustomElement)('application-component', function () {
  ...
  this.querySelector('button.expandApplication').addEventListener('click', function (e) {
    var application = _this.querySelector('.artist-application-review');
          ...
          customElementType = /*#__PURE__*/function (_HTMLElement) {
            ...
            return _createClass(customElementType, [{
              ...
              value: function updateTemplate() {
                ...
                var context = _defineProperty(_defineProperty(_defineProperty({
                ...
                }, "artistStatement", this.getAttribute('artistStatement') || ''), "websiteSocialMedia", this.getAttribute('website-social-media') || ''), "randomId", randomId);
